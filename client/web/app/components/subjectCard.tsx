...
export const SubjectCard = ({
  ...
  return (
    <Link
      to={`/subject/${uuid}`}
      className="hover:border-highlight p-3 border border-mainLighter w-80 h-80 rounded-3xl flex flex-col justify-center items-center space-y-5 bg-mainLighter transition-all"
    >
